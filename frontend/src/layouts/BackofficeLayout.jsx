...
import {
  ...
  GitMerge, Calculator, LayoutGrid, Shield, ShoppingCart, Zap, ShieldAlert,
} from 'lucide-react';
...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/backoffice/supressao-rede', icon: Shield, label: 'Supressão de rede', testId: 'nav-network-suppression', perm: 'commercial' },
      { to: '/backoffice/convenio', icon: Store, label: 'Convênio (Empresas)', testId: 'nav-convenio', perm: 'commercial' },
      { to: '/backoffice/convenio/faturamento', icon: Receipt, label: 'Convênio · Faturamento', testId: 'nav-convenio-billing', perm: 'financial' },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/backoffice/auditoria', icon: ShieldAlert, label: 'Auditoria & Logs', testId: 'nav-audit-logs' },
